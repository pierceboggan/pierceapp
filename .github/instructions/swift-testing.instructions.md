...
applyTo: "**/Tests/**/*.swift,**/*Tests.swift,**/*Test.swift"
---
...
Use the **Swift Testing** framework (not XCTest) for all tests. Tests should be placed in the Package's Tests directory.
...
All tests should follow these modern Swift Testing patterns and be placed in the appropriate test targets within the Package's Tests directory.
