...
public struct DailyScoreCard: View {
    let score: Double
    @EnvironmentObject var themeService: ThemeService
...
public struct WaterTrackerCard: View {
    let current: Double
    let target: Double
    let onAddWater: () -> Void
...
public struct ReadingProgressCard: View {
    let book: Book
...
public struct AddBookPromptCard: View {
    @EnvironmentObject var themeService: ThemeService
...
public struct TodayHabitsCard: View {
    @EnvironmentObject var themeService: ThemeService
    @EnvironmentObject var habitService: HabitService
...
public struct TodayCleaningCard: View {
    @EnvironmentObject var themeService: ThemeService
    @EnvironmentObject var cleaningService: CleaningService
...
public struct CleaningTaskRowView: View {
...
public struct MobilityRoutineCard: View {
    let onTap: () -> Void
